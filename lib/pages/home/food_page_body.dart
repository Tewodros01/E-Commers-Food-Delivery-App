  ...
  Widget build(BuildContext context) {
    return Column(
      children: [
        ...
        GetBuilder<RecommendedProductController>(builder: (recommendedProdct) {
          return recommendedProdct.isLoaded
              ? ListView.builder(
                  physics: const NeverScrollableScrollPhysics(),
                  shrinkWrap: true,
                  itemCount: recommendedProdct.recommendedProductList.length,
    ...
    return Transform(
      ...
      child: Stack(
        children: [
          GestureDetector(
            onTap: () {
              Get.toNamed(RouteHelper.getPopulrFood(index));
            },
            child: Container(
